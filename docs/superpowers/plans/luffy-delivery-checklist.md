...
[owner-clarification addendum](../specs/2026-09-21-m32-scheme-d-owner-clarifications-i1-i8.md)
...
## Session update — September 21, M3.2 validation bundle assembled

[Report](../reports/2026-09-21-m32-validation-bundle.md), bundle
...
Checklist count unchanged (M3.2 not accepted); protocol section 14 items other than the
benchmark are now bound in the bundle.
