"""Guard the RNG-free M3.2 validation bundle: hash binding, recorded preflight, fail-closed gating."""
import hashlib
import json
import os
import subprocess
...
BUNDLE = ROOT / "scripts/m32_scheme_d_validation_bundle_20260921"
...
def test_recorded_preflight_is_clean_and_rng_free():
    ...
    assert report["result"] == "PASS" and report["checks_total"] == report["checks_passed"] == 22
